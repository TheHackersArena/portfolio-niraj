          ...
          >
            ...
            <div className="space-y-4">
              <a 
                ...
                className="flex items-center gap-3 p-4 card hover:border-primary/30 transition-colors"
              >
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">nirajkumar4598@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">linkedin.com/in/nirajkryadav</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-foreground/70 text-sm">github.com/nirajkumar</p>
                </div>
              </a>
            </div>
          </motion.div>
